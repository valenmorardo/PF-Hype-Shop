...
const UpdateProduct = () => {
    ...
    console.log(sneakerDetail.attributes)
    // para validaciones:
    ...
    condition: sneakerDetail.condition ? sneakerDetail.condition :"",
      ...
      age_group: "",
      brand: sneakerDetail.attributes[5].value.toString() ? sneakerDetail.attributes[5].value.toString():"",
      externalMaterial: sneakerDetail.attributes[6].value ? sneakerDetail.attributes[6].value:"",
      shoeStyle: sneakerDetail.shoeStyle? sneakerDetail.shoeStyle:"Zapatilla",
      size: sneakerDetail.attributes[2].value ? sneakerDetail.attributes[2].value:"",
      imgInput: 0,
      laImg: 0,
      color:sneakerDetail.attributes[0].value ? sneakerDetail.attributes[0].value:"",
      iLocalPictures: [],
      category: sneakerDetail.attributes[4].value ? sneakerDetail.attributes[4].value:"",
      stock:"",
      variations:[],
      genero: sneakerDetail.attributes[1].value ? sneakerDetail.attributes[1].value: "",
